...
public class AccessRequestHandler {
	...
	static Logger logger = Logger.getLogger(AccessRequestHandler.class);
	...
	public static Response handleRequest(Request request) {
		try {
			...
			IAccessModel model = (IAccessModel)RMIConnectionPool.getInstance().getRemoteServiceObject(Const.ACCESS_MODEL_SERVICE);
