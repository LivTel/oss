...
public class GatekeeperRequestHandler {
	
	static Logger logger = Logger.getLogger(GatekeeperRequestHandler.class);
	
	public GatekeeperRequestHandler() {
	...
	public static Response handleRequest(Request request) {
		try {
			...
			ILockingModel model = (ILockingModel)RMIConnectionPool.getInstance().getRemoteServiceObject(Const.LOCKING_MODEL_SERVICE);
