...
public class TagAccountRequestHandler {
	
	static Logger logger = Logger.getLogger(TagAccountRequestHandler.class);
	
	public TagAccountRequestHandler() {
	...
	public static Response handleRequest(Request request) {
		try {
			...
			IAccountModel model = (IAccountModel)RMIConnectionPool.getInstance().getRemoteServiceObject(Const.TAG_ACCOUNT_SERVICE);
