...
public class ProposalAccountRequestHandler {
	
	static Logger logger = Logger.getLogger(ProposalAccountRequestHandler.class);
	
	public ProposalAccountRequestHandler() {
	...
	public static Response handleRequest(Request request) {
		try {
			...
			IAccountModel model = (IAccountModel)RMIConnectionPool.getInstance().getRemoteServiceObject(Const.PROPOSAL_ACCOUNT_SERVICE);
